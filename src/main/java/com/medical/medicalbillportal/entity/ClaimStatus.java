...
/**
 * Claim workflow status codes (stored in DB as String).
 * We keep DB as String to avoid breaking repository queries,
 * while using this enum for safer, readable finance transitions.
 */
public enum ClaimStatus {
	PENDING("PENDING"),
	SUBMITTED("SUBMITTED"),
	RECEPTION_VERIFIED("RECEPTION_VERIFIED"),
	ON_HOLD("ON_HOLD"),
